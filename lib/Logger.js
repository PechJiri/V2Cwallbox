...
class Logger {
    ...
    // Logger neudržuje vlastní frontu zpráv - logy jdou rovnou do Homey.
    // Metoda existuje kvůli kompatibilitě (volá ji device.onDeleted) a pro
    // budoucí případnou lokální historii.
    async clearHistory() {
        return;
    }
}
