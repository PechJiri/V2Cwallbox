...
module.exports = {
    ...
    DEVICE_CAPABILITIES: [
        ...
        'evcharger_charging',
        'ev_charging_session_energy',
        'ev_charging_session_duration',
        'onoff',
        'locked',
        'alarm_generic',
    ...
    INTERVALS: {
        ...
        DISCONNECTED: 60000,  // Stav 0 - auto odpojeno (60s)
    },

    // Exponenciální backoff pro API volání při chybách
    BACKOFF: {
        BASE_MS: 1000,        // Výchozí zpoždění po první chybě
        MAX_MS: 60000         // Strop pro odkládání dalšího volání
    },
