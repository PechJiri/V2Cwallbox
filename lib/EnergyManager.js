...
class EnergyManager {
    ...
    async processEnergyData(deviceData, previousState, currentState) {
        try {
            ...
            switch (currentState) {
                case CONSTANTS.CHARGE_STATES.CHARGING: // Nabíjení
                ...
                case CONSTANTS.CHARGE_STATES.DISCONNECTED: // Odpojeno
                    if (previousState === CONSTANTS.CHARGE_STATES.CHARGING || 
                ...
                case CONSTANTS.CHARGE_STATES.CONNECTED: // Připojeno, ale nenabíjí
                    if (previousState === CONSTANTS.CHARGE_STATES.CHARGING) {
                        chargeEnergy = storedBaseEnergy + currentEnergy;
